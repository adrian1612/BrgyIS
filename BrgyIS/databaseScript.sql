USE [master]
GO
/****** Object:  Database [dbBrgyIS]    Script Date: 11/05/2024 12:27:02 pm ******/
CREATE DATABASE [dbBrgyIS]
GO
USE [dbBrgyIS]
GO
/****** Object:  StoredProcedure [dbo].[tbl_Person_Proc]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[tbl_ref_Position_Proc]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[tbl_Staff_Proc]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[tbl_User_Proc]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[FullnameFormat]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_FormIssuance]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_Person]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tbl_ref_Position]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[tbl_Staff]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_User]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  View [dbo].[vw_Person]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_Staff]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[vw_FormIssuance]    Script Date: 11/05/2024 12:27:02 pm ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (1, 1, N'Brgy. Clearance', NULL, 0, CAST(0x0000B157010DB82E AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (2, 2, N'Brgy. Clearance', NULL, 1, CAST(0x0000B15701165F5F AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (3, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B16000C690B5 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (4, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B16000C6DF5C AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (5, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B16000C771CD AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (6, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B16000C78F3E AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (7, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B1600169D3FD AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (8, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016A3E43 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (9, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016A821E AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (10, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016A9D6A AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (11, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016AAA5B AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (12, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016AB66B AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (13, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016AD8DB AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (14, 1, N'Late Filing of Birth', NULL, 1, CAST(0x0000B160016B17F8 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (15, 1, N'Late Filing of Birth', NULL, 1, CAST(0x0000B160016B7AC0 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (16, 1, N'Late Filing of Birth', NULL, 1, CAST(0x0000B160016BC09C AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (17, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016BC9BF AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (18, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016BF4FC AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (19, 1, N'Brgy. Clearance', NULL, 1, CAST(0x0000B160016C6BB1 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (20, 1, N'Certificate of Residency', NULL, 1, CAST(0x0000B160016DDC15 AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (21, 1, N'Certificate of Residency', NULL, 1, CAST(0x0000B160016E1ECC AS DateTime))
GO
INSERT [dbo].[tbl_FormIssuance] ([ID], [Person], [Form], [Reason], [Encoder], [Timestamp]) VALUES (22, 1, N'Certificate of Indigency', N'Mag aabroad po', 1, CAST(0x0000B16D00A91820 AS DateTime))
GO
...
GO
ALTER TABLE [dbo].[tbl_FormIssuance] ADD  CONSTRAINT [DF__tbl_FormI__Times__15502E78]  DEFAULT (getdate()) FOR [Timestamp]
GO
